...
from scrapers.scrapers_ifp.spiders.rne_spider import (
    RneSenateursSpider,
)
...
def mock_catalog_response():
    ...
    body = json.dumps(
        {
            "resources": [
                {"title": "elus-senateurs-sen.csv", "id": "ID-SENATEURS-123"},
