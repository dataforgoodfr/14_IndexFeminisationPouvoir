...
def parse_arguments():
    ...
    Arguments :
        ...
        --spiders (list) : Liste spécifique des noms de spiders à lancer, ou tous les spiders si non spécifié (défaut)
...
if __name__ == "__main__":
    ...
    orchestrator = SpiderOrchestrator(
        ...
        target_spiders=args.spiders,
        run_all=len(args.spiders or []) == 0,
    )
    orchestrator.run()
