-- models/exports/gouv_postes_régaliens.sql
...
{% set ref_postes_régaliens_src = var('schema_source') ~ '.ref_postes_régaliens_' ~ var('annee') %}
...
inner join {{ ref_postes_régaliens_src }} r
