...
export default function Page() {
  ...
  return (
    <div className="flex flex-col mt-20 gap-8  items-center justify-center ">
      <PageTitle title="Pouvoir local" subtitle="Le pouvoir local correspond aux élu·e·s des collectivités territoriales." />
      <Hero>
        <PouvoirFigure
          valeur={parite}
          icon={FemmeElueIcon}
      ...
      <div className="p-8 flex flex-col gap-8">
        ...
        <GenderDistributionChart pourcentage={local.postes_regaliens} />
        <h2
          className="text-2xl/relaxed font-bold text-center"
          id="gouvernement"
        >
        ...
        <GenderDistributionChart pourcentage={local.gouvernement} />
        <h2
          className="text-2xl/relaxed font-bold text-center"
        ...
        <GenderDistributionChart pourcentage={local.cabinet_president} />
        <h2
          className="text-2xl/relaxed font-bold text-center"
        ...
        <GenderDistributionChart
          pourcentage={local.cabinet_premier_ministre}
        />
        <h2
          className="text-2xl/relaxed font-bold text-center"
        ...
        <GenderDistributionChart pourcentage={local.cabinet_gouvernement} />
      </div>
    </div>
  );
}
